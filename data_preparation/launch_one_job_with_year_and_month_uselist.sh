...
case "$YEAR" in
    2021) save_dir="/scratch5/BMC/ai-datadepot/projects/aschein/ADAF_new/data_uselist/train_data" ;;
    2022) save_dir="/scratch5/BMC/ai-datadepot/projects/aschein/ADAF_new/data_uselist/valid_data" ;;
    2023) save_dir="/scratch5/BMC/ai-datadepot/projects/aschein/ADAF_new/data_uselist/test_data" ;;
    *)
...
#SBATCH --output=logs/analysis_uselist_${YEAR}_${MONTH}_%J.out
#SBATCH --error=logs/analysis_uselist_${YEAR}_${MONTH}_%J.err
